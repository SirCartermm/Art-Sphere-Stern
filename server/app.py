...
#         current_user_id = get_jwt_identity()
#         user = User.query.get(current_user_id)
#         return {'message': 'Welcome to your dashboard', 'user': user.to_dict()}, 200
...
#         db.session.add(artwork)
#         db.session.commit()
#         return {'message': 'Artwork created successfully'}, 201
...
#         db.session.add(exhibition)
#         db.session.commit()
#         return {'message': 'Exhibition created successfully'}, 201

#     def get(self, id=None):
#         if id:
#             exhibition = Exhibition.query.get_or_404(id)
#             return exhibition.to_dict(), 200
#         else:
#             exhibitions = Exhibition.query.all()
#             return [exhibition.to_dict() for exhibition in exhibitions], 200
...
#         exhibition.description = data['description']
#         db.session.commit()
#         return {'message': 'Exhibition updated successfully'}, 200
...
#         db.session.delete(exhibition)
#         db.session.commit()
#         return {'message': 'Exhibition deleted successfully'}, 200
...
#         db.session.add(artwork_exhibition)
#         db.session.commit()
#         return {'message': 'Artwork added to exhibition successfully'}, 201
...
#         db.session.delete(artwork_exhibition)
#         db.session.commit()
#         return {'message': 'Artwork removed from exhibition successfully'}, 200
...
#             artist.image = data.get('image', artist.image)
#             db.session.commit()
#             return {'message': 'Artist updated successfully'}, 200
#         except ValueError:
#             return {'message': 'Invalid birthdate format. Use YYYY-MM-DD.'}, 400
...
#         db.session.delete(user)
#         db.session.commit()
#         return {'message': 'Artist and associated user deleted successfully'}, 200


# # Registering resources with their respective endpoints
# api.add_resource(Register, '/register')
# api.add_resource(Login, '/login')
# api.add_resource(Logout, '/logout')
# api.add_resource(Dashboard, '/dashboard')
# api.add_resource(ArtworkResource, '/artworks', '/artworks/<int:id>')
# api.add_resource(ExhibitionResource, '/exhibitions', '/exhibitions/<int:id>')
# api.add_resource(ArtworkExhibitionResource, '/exhibitions/<int:exhibition_id>/artworks/<int:artwork_id>')
# api.add_resource(ArtistResource, '/artists', '/artists/<int:id>')
